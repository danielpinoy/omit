...
**Omit does not transmit any data off your device.** There are:
...
All processing happens locally within the extension running in your browser.
...
Any changes to this privacy policy will be reflected in the extension's GitHub repository and the Chrome Web Store listing.
